...
class EmiLoanCalc extends StatelessWidget {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("EMI Home Loan Calculator", textAlign: (TextAlign.center),style: TextStyle(fontSize: 11, fontWeight: FontWeight.w900,color: Colors.black),),
            )
          ],
        ),
        onPressed: () {
                ...
                child: Container(
                  ...
                  child: ListView(
                    children: <Widget>[
                      ...
                      Center(
                        child: Text("EMI Home Loan Calculator",
...
class EmiHomeLoanForm extends StatefulWidget {
@override
_EmiHomeLoanFormState createState() => _EmiHomeLoanFormState();
}

class _EmiHomeLoanFormState extends State<EmiHomeLoanForm> {
        ...
        children: <Widget>[
            ...
            child: Align(
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(text: "Home Loan Amount", style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.w900)),
          ...
          Center(
            child: Container(
              ...
              child: RaisedButton(
                color: kPrimaryColor,
                child: Text('Check Home Loan', style: TextStyle(color: Colors.white,fontSize: 20, fontWeight: FontWeight.w800)),
                onPressed: () {
                  setState(() {
                    int sum = int.parse(homeLoanAmount.text)*int.parse(interestRate.text);
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(text: "Invest In SIP's to reach your house goal.", style: TextStyle(fontSize: 13.0, fontWeight: FontWeight.w400),),
                      ],
                    ),
                  ),
                ),
